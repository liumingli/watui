...
import com.ybcx.watui.facade.AppStarter;
...
public class AppStarter extends HttpServlet implements ApplicationListener,
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		//微博接入有关api
		if(action.equals(AppStarter.YONKOMATOWEIBO) ||
				action.equals(AppStarter.GETUSERINFO) ||
				action.equals(AppStarter.OPERATEWEIBOUSER)){
	...
	private void weiboProcess(String action, HttpServletRequest req,
		...
		}else if(action.equals(AppStarter.OPERATEWEIBOUSER)){
			//判断用户是存在，存在更新，否则新建
			res.setContentType("text/plain;charset=UTF-8");
			PrintWriter pw = res.getWriter();
			String userId =req.getParameter("userId");
